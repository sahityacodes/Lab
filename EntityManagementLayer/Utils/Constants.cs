namespace EntityManagementLayer.Utils
{
    sealed class Constants
    {
        ...
        //Order Queries
        public static string QUERY_SELECTALLORDERS = "SELECT * FROM SalesOrders s INNER JOIN SalesOrdersTails tail on s.OrderID = tail.OrderID";
        ...
        public static string QUERY_DELETEONE_ROW = "Delete from SalesOrdersRows where OrderID=@OrderID;Delete from SalesOrdersTails where OrderID=@OrderID";
